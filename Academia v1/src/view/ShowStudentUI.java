...
public class ShowStudentUI extends JPanel {
	...
	public ShowStudentUI() {
		...
		lblShowStudent = new JLabel("MOSTRAR ALUMNO");
		lblShowStudent.setFont(new Font("Tahoma", Font.PLAIN, 21));
		GridBagConstraints gbc_lblShowStudent = new GridBagConstraints();
		gbc_lblShowStudent.gridwidth = 3;
		gbc_lblShowStudent.insets = new Insets(0, 0, 5, 5);
		gbc_lblShowStudent.gridx = 1;
		gbc_lblShowStudent.gridy = 1;
		add(lblShowStudent, gbc_lblShowStudent);
